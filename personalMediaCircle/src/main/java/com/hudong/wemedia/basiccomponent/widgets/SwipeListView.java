...
public class SwipeListView
    ...
    public void setCanSwipe(boolean swipeState){
        isCanSwipe = swipeState;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (mCurrentItemView != null && motionPosition != AdapterView.INVALID_POSITION){
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    break;
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mIsHorizontal) {
                        if (mIsShown && mPreItemView != mCurrentItemView && mCurrentItemView != null) {
                        /* * 情况二：
                         * <p>
                         * 一个Item的右边布局已经显示，
                         * <p>
